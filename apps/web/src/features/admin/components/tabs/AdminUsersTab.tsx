...
export function AdminUsersTab() {
  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[1fr_320px]">
      ...
      <form
        className="ui-card flex h-fit flex-col gap-3 p-5 shadow-clay border-2 border-brand-100/70"
        onSubmit={(e) => void createUser(e)}
      >
        <h2 className="font-display text-xl font-bold text-text">Tạo tài khoản mới</h2>
        <label className="flex flex-col gap-1 text-sm font-bold">
          Vai trò
          <select
            className="min-h-11 rounded-xl border-2 border-border px-3 bg-white"
        ...
        <Button type="submit" className="mt-1 shadow-clay font-bold">
          Tạo tài khoản
        </Button>
      </form>
