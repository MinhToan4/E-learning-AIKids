...
export function InteractiveCoachPanel({
  guideCopy,
  videoUrl,
  videoTitle,
}: InteractiveCoachPanelProps) {
  const [showHint, setShowHint] = useState(false)

  return (
    <aside className="lesson-guide-panel flex flex-col items-center justify-start text-center w-full" aria-labelledby="lesson-guide-title">
      <AikidCatCharacter
        pose={guideCopy.pose}
