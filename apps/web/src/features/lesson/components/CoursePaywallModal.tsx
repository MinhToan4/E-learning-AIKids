...
export function CoursePaywallModal({
  ...
  const description = isCreditsMode
    ...
    : 'Chúc mừng con đã hoàn thành 10 Quy tắc của Xưởng sáng tạo! Để mở khóa toàn bộ các chặng học chính thức tiếp theo và nhận 50 lượt tạo ảnh AI kỳ diệu mỗi tháng, ba mẹ hãy mở khóa Gói AI Kid cho con nhé!'
    ...
    >
      {isCreditsMode ? (
        <div className="w-full max-w-lg mx-auto space-y-4">
          {/* Card nạp thêm lượt */}
          <div className="rounded-3xl border-2 border-cream-300 bg-gradient-to-b from-sky-50/70 via-cream-50/60 to-white p-5 sm:p-6 shadow-soft text-left">
            <div className="flex items-center justify-between gap-3 border-b border-cream-300/70 pb-4">
              <div>
                <span className="inline-flex items-center gap-1 rounded-full bg-sky-100 border border-sky-200 px-3 py-0.5 text-xs font-black text-sky-800">
                  ⚡ GÓI NẠP NHANH
                </span>
                <h3 className="mt-1 text-lg sm:text-xl font-display text-text font-black">
                  Gói Bổ Sung 25 Lượt Tạo Ảnh AI
                </h3>
              </div>
              <div className="text-right shrink-0">
                <span className="block text-xl sm:text-2xl font-black text-brand-600 font-display">
                  50.000đ
                </span>
                <span className="text-[11px] font-bold text-muted">2.000đ / lượt</span>
              </div>
            </div>

            <ul className="mt-4 space-y-2.5 text-sm font-bold text-text">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Button
              className="w-full sm:w-auto px-6 py-3.5 text-sm sm:text-base font-black shadow-clay active:shadow-press"
              onClick={onUpgrade}
            >
            ...
            <Button
              variant="secondary"
              className="w-full sm:w-auto px-6 py-3.5 text-sm sm:text-base font-bold"
        ...
        <div className="w-full max-w-lg mx-auto space-y-4">
          ...
          <div className="rounded-3xl border-2 border-cream-300 bg-gradient-to-b from-cream-50 via-sun-50/50 to-white p-5 sm:p-6 shadow-soft text-left">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-cream-300/70 pb-4">
              <div>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-100 border border-amber-200 px-3 py-0.5 text-xs font-black text-amber-800">
              ...
              <div className="text-right">
                ...
                <span className="text-[11px] font-bold text-muted">(Chưa tới 4.500đ/ngày)</span>
              </div>
            </div>

            <ul className="mt-4 space-y-3 text-sm font-bold text-text">
              <li className="flex items-start gap-2.5">
